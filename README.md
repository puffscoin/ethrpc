...
var address = rpc.puffs.getTransactionReceipt(txHash).contractAddress;
// address:
...
```javascript
var contractCode = rpc.puffs.getCode("0x86fb6d1f1bd78cc13c6354b6436b6ea0c144de2e");
// contractCode:
